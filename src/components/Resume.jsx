...
import './Resume.css';
import { FaEnvelope, FaMapMarkerAlt, FaLinkedin, FaMedium, FaStar, FaTrophy, FaAward, FaLanguage, FaBook } from 'react-icons/fa';
      ...
      <div className="resume-content">
        <div className="left-column">
          <section className="experience">
            ...
            <div className="job">
              ...
              <span className="contact-info"><a href="https://www.visionet.com/" target="_blank" rel="noopener noreferrer">Visionet Inc. </a> | 07/2022 - Present | <FaMapMarkerAlt /> Lahore, Punjab, Pakistan</span>
              <ul>
            ...
            <div className="project-list">
              <div className="project-item">
                ...
                <p className="tech-stack">
                  {['AWS ՄEKS, Bedrock)', 'Dataiku', 'Langchain', 'LLM', 'MLFLOW', 'Jenkins', 'MLOps', 'Prompt Engineering'].map((tech, index) => (
              ...
              <div className="project-item">
                ...
                <ul>
                  <li>Spearheaded the transition from a linear to a multivariate projection strategy, achieving a substantial 63% reduction ՄMAPEՅ</li>
                  ...
                  <li>Tackled challenges arising from diverse data sources (e.g., sales, Google Trends, Reviews, GDPՅ and coped with limited historical data through advanced back-forecasting techniques</li>
                  <li>Engineered COVID Recovery Forecasting models to interpret the unique behaviors in sales signals during the pandemic, specifically addressing variations between Brick-and-Mortar ՄB&MՅ and E-commerce channels</li>
                  <li>Executed a sophisticated forecasting scope, encompassing major and sub-categories, inclusive of competitors' sales data, navigating intricate technicalities during the unpredictable period of the COVID՞19 pandemic</li>
                </ul>
              </div>
              ...
              <div className="project-item">
                ...
                <ul>
                  <li>Employed advanced computer vision and deep learning techniques, including YOLOv2 for object detection and Deep SORT for object tracking</li>
        ...
        <div className="right-column">
          ...
          <section className="certifications">
            ...
            <div className="certification-list">
              <div className="certification-item">
                <p>Building Trustworthy AI Enterprise Solutions | <strong class="bold-color">IBM</strong></p>
              </div>
              <div className="certification-item">
                <p>Enterprise Data Science in Practice | <strong class="bold-color">IBM</strong></p>
              </div>
              <div className="certification-item">
                <p>Effective Leadership | <strong class="bold-color">HP</strong></p>
              </div>
              <div className="certification-item">
                <p>Sales Forecasting | <strong class="bold-color">HP</strong></p>
              </div>
              <div className="certification-item">
                <p>Dataiku Core Designer | <strong class="bold-color">Dataiku</strong></p>
              </div>
              <div className="certification-item">
                <p>Managing Machine Learning Projects with Google Cloud | <strong class="bold-color">Google</strong></p>
              </div>
              <div className="certification-item">
                <p>The Data Scientist's Toolbox | <strong class="bold-color">The Johns Hopkins University</strong></p>
              </div>
              <div className="certification-item">
                <p>Hadoop Platform and Application Framework | <strong class="bold-color">UC San Diego</strong></p>
              </div>
              <div className="certification-item">
                <p>Machine Learning: A Case Study Approach | <strong class="bold-color">University of Washington</strong></p>
              </div>
              <div className="certification-item">
                <p>Introduction to Big Data | <strong class="bold-color">UC San Diego</strong></p>
              </div>
            </div>
          </section>
          ...
          <section className="publications">
            ...
            <ul>
              <li class="contact-info"><a href="https://pub.towardsai.net/multimodal-deep-multipage-document-classification-using-both-image-and-text-629e5a2fdb47">Multimodal Deep Multipage Document Classification | <strong class="bold-color">Towards AI</strong></a> </li>
              <li class="contact-info"><a href="https://towardsdatascience.com/multi-page-document-classification-using-machine-learning-and-nlp-ba6151405c03">Multi Page Document Classification |  <strong class="bold-color">Towards Data Science</strong></a></li>
              <li class="contact-info"><a href="https://medium.com/@qaisartanvir/data-drift-analysis-using-deep-learning-and-novelty-detection-e6223f9dcbb3">Data Drift Detection using Deep Learning | <strong class="bold-color">Medium</strong></a></li>
            </ul>
          </section>
          ...
          <section className="additional-experience">
            ...
            <div className="job">
              ...
              <span>Lahore University of Management Sciences (LUMS) | 09/2018 - 12/2018 | <FaMapMarkerAlt /> Lahore, Pakistan</span>
              <ul>
          ...
          <section className="skills">
            <h2>Skills</h2>
            <p className="tech-stack">
              {['Python', 'Deep Learning', 'Machine Learning', 'MLOps', 'NLP', 'Computer Vision', 'Time-Series Forecasting', 'GenAI', 'LLM', 'AWS', 'GCP', 'Databricks', 'PySpark', 'Kubernetes', 'CUDA', 'MLFLOW', 'TensorFlow', 'Keras', 'PyTorch', 'LangChain', 'CI/CD', 'Document AI', 'Arthur AI'].map((tech, index) => (
                <span key={index} className="tech-tag">{tech}</span>
              ))}
            </p>
          </section>
